...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>60th Anniversary 1960 Les Paul Standard - V1 Deep Cherry Sunburst</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="data-title">
                        <h1>60th Anniversary 1960 Les Paul Standard - V1 Deep Cherry Sunburst</h1>
                    </div>
                    <div class="data01 col-xl-6">
                        <img class="dataphoto" src="assets/img/post/guitar01.jpg">
                    </div>
                    <div class="data-detail  col-xl-6">
                        <p>樂器別：電吉他</p>
                        <p>上架日期：2020/07/02</p>
                        <p>製造商： Gibson Brands, Inc.</p>
                        <p>製造日期：2015/03/01</p>
                        <p>附屬配件：無</p>
                        <br>
                        <table>
                        ...
                        <div class="order">
                            <div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s">
                                <a href="../contract/music_chose_guitar.php" class="btn hero-btn">我要租借</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="message">
                        <table>
                            <tr>
                                <td><a href="1959-introduce.html" target="infor">樂器介紹</a></td>
                                <td><a href="1959_record.php" target="infor">租借紀錄</a></td>
                                <td><a href="1959-contact.html" target="infor">聯絡我們</a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="iframe">
                        <br>
                        <iframe src="1959-introduce.html" name="infor" scrolling="no"></iframe>
                    </div>            
                </div>
            </div>
        </div>
...
<div id="back-top" >
    ...
    <!-- JS here -->
        ...
        <?php
		require 'contract_address_guitar.php';
        ?>
         <script >
        //有要抓取的變數顯示

                        ...
                        <div class="about-details-cap mb-50">
                                <div class="select" >
                                        ...
                                        <div style="padding-bottom: 50px;"> 
                                            ...
                                            type="button" onclick="window.open('https://rinkeby.etherscan.io/address/0x783ff570e335fc4ae5187ab2d68653f3db3e20c0','_blank')">查看區塊鏈上的合約</button> 
                                        </div>
                                </div>
                        </div>
                    </div>
...
<div id="back-top" >
    ...
    <!-- JS here -->
        ...
        function sdtodb(){
            <?php                      
            $sql_query = "INSERT INTO transaction (`email`,`startDate`,`endDate`,`tEth`,`pName`,`pType`)VALUES ('{$email}','{$startDate}','{$endDate}','{$money}','piano','{$fun}')";//insert data 

                        ...
                        <div class="about-details-cap mb-50">
                                <div class="select" >
                                        ...
                                        <div style="padding-bottom: 50px;"> 
                                            ...
                                            type="button" onclick="window.open('https://rinkeby.etherscan.io/address/0x3ce1617e6bfbab6bc6a67a5d47dd6b5c013a5ce2','_blank')">查看區塊鏈上的合約</button> 
                                        </div>
...
<div id="back-top" >
    ...
    <!-- JS here -->
        ...
        function sdtodb(){
            <?php                      
            $sql_query = "INSERT INTO transaction (`email`,`startDate`,`endDate`,`tEth`,`pName`,`pType`)VALUES ('{$email}','{$startDate}','{$endDate}','{$money}','bass','{$fun}')";//insert data 

...
<head>
    ...
    <title>owner_cansee_Guitar</title>
                    ...
                    <div class="row">
                        <div class="about-details-cap mb-50">
                            <div class="select" style= "text-align: left;">
                                ...
                                <h3 style= "display:block">租借金額：<em id="TotalAmount"></em></h3>
                                <h3 style= "display:block">租借方案：<em id="R_Fun"></em></h3>
  
                                <input type="button" id="restart" value="重啟合約">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        async function init2() {
            ...
            Contract.methods.R_Fun().call().then(function (result) {
                if (result == 1) {
					document.getElementById('R_Fun').textContent = "日租方案";
				}
				else if (result == 2){
					document.getElementById('R_Fun').textContent = "週租方案";
				}
                else if (result == 3){
					document.getElementById('R_Fun').textContent = "月租方案";
				}
				else {
					document.getElementById('R_Fun').textContent = "請洽管理人員";
				}
        });

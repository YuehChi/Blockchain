...
<head>
    ...
    <title>Contract_For_Guitar</title>
                        ...
                        <div class="about-details-cap mb-50">
                                <div class="select" >
                                        ...
                                        <div style="padding-bottom: 50px;"> 
                                            ...
                                            type="button" onclick="window.open('https://rinkeby.etherscan.io/address/0xa1f1350dea9c0ce652a9c429659debddc11a5b44','_blank')">查看區塊鏈上的合約</button> 
                                        </div>      
                                </div>
                        </div>
                    </div>
...
<div id="back-top" >
    ...
    <!-- JS here -->
        ...
        function sdtodb(){
            <?php                      
            $sql_query = "INSERT INTO transaction (`email`,`startDate`,`endDate`,`tEth`,`pName`,`pType`)VALUES ('{$email}','{$startDate}','{$endDate}','{$money}','guitar','{$fun}')";//insert data 
            mysqli_query($db, $sql_query);
            header("Location:https://rinkeby.etherscan.io/address/0xa1f1350dea9c0ce652a9c429659debddc11a5b44"); 
            ?>
        }
        </script>
